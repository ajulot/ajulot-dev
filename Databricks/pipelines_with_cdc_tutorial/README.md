...
The 'pipelines_with_cdc_tutorial' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/pipelines_with_cdc_tutorial/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] pipelines_with_cdc_tutorial_etl` to your workspace.
